List<Map<String, dynamic>> questionData = [
  ...
  {
    "question": "Which of the following represents a blue-chip stock?",
    "options": {
  ...
  {
    "question": "Which stock exchange is located in New York and is considered the largest in the world by market capitalization?",
    "options": {
  ...
  {
    "question": "What is the primary role of the Securities and Exchange Commission (SEC) in the United States?",
    "options": {
  ...
  {
    "question": "When a stock is labeled as “overbought,” what does it mean?",
    "options": {
  ...
  {
    "question": "What is the significance of the stock market index like the S&P 500?",
    "options": {
  ...
  {
    "question": "Which of the following is an example of a technical analysis tool used by traders to identify price trends and patterns?",
    "options": {
      "a": "Income statement",
      "b": "Balance sheet",
      "c": "Moving average",
