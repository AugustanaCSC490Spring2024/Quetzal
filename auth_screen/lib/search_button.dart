...
class CustomSearch extends SearchDelegate<String> {
      ...
      return FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return _buildSuggestionsList(context, snapshot.data!);
          } else {
  ...
  Widget _buildSuggestionsList(BuildContext context, List<Map<String, dynamic>> suggestions) {
  ...
  Future<Map<String, dynamic>> _fetchTickerInfo(String ticker) async {
    ...
    final response = await http.get(
      Uri.parse('https://api.polygon.io/v3/reference/tickers/$ticker?date=$formattedDate&apiKey=$apiKey'),
    );
