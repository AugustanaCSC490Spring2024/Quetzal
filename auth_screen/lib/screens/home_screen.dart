...
//                 mainAxisAlignment: MainAxisAlignment.center,
//                 children: [
//                   LiveStockChart(ticker: 'AAPL', userStockPrice: 150.0), // Replace 'AAPL' with your stock ticker and set the user stock price
//                   PortfolioManagementWidget(),
//                   _buildUserMoney(),
//                   const SizedBox(height: 20),
//                   _buildStockWidgets(),
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => Scaffold(
                appBar: AppBar(title: Text('Test Live Stock Chart')),
                body: TestLiveStockChart(ticker: 'AAPL', userStockPrice: 150.0), // Use your test chart here
              ),
            ),
          );
        },
